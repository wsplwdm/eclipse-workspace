...
* <P>
* @author Owen Astrachan, Szymon Bobek
...
public class BitInputStream extends InputStream
{
 ...
 public void reset() throws IOException
 {
     ...
     try{
         ...
         os.write(ByteBuffer.allocate(Integer.SIZE/Byte.SIZE).putInt(payloadLength).array());
         sizeInput = new ByteArrayInputStream(os.toByteArray());
     }
 ...
 public int readBits(int howManyBits) throws IOException
 {
     ...
     while (howManyBits > myBitCount){
         ...
         try{
             if ( (myBuffer = sizeInput.read()) == -1 && (myBuffer = myInput.read()) == -1) {
                 return -1;
             }
         }
